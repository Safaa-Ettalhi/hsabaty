...
describe('ExportService', () => {
    ...
    describe('exporterTransactionsCSV', () => {
        it('should create a CSV file', async () => {
            ...
            const result = await ExportService.exporterTransactionsCSV('user1', transactions);
    ...
    describe('exporterTransactionsExcel', () => {
        it('should create an Excel buffer', async () => {
            ...
            const buffer = await ExportService.exporterTransactionsExcel('user1', transactions);
    ...
    describe('exporterRapportPDF', () => {
        it('should create a PDF buffer', async () => {
            ...
            const promise = ExportService.exporterRapportPDF('Titre', donnees, 'user1');
