...
class EmailService {
    //envoyer un email
    static async envoyerEmail(destinataire, sujet, contenu, pieceJointe) {
    ...
    static async envoyerRapport(email, nomUtilisateur, rapportPDF, typeRapport) {
    ...
    static async envoyerAlerteBudget(email, nomUtilisateur, nomBudget, pourcentageUtilise, montantRestant) {
    ...
    static async envoyerLienReinitialisation(email, nomUtilisateur, lienReset) {
    ...
    static async envoyerRappelTransactionRecurrente(email, nomUtilisateur, description, montant, dateEcheance) {
