...
const dateOptionnelleVersDate = () =>
    z.union([z.string(), z.date()]).optional().transform((v) => (v ? new Date(v) : new Date()));

const dateStringOptionnelleVersDate = () =>
    z.string().optional().transform((v) => (v ? new Date(v) : undefined));

exports.authInscriptionSchema = z.object({
    body: z.object({
...
exports.authConnexionSchema = z.object({
    body: z.object({
        email: z.string().email('Email invalide'),
        motDePasse: z.string().min(1, 'Le mot de passe est requis')
    })
});
exports.authMotDePasseOublieSchema = z.object({
    body: z.object({
        email: z.string().email('Email invalide').max(255)
    })
});
exports.authReinitialiserMotDePasseSchema = z.object({
    body: z.object({
...
exports.authProfilModifierSchema = z.object({
    body: z
        .object({
...
exports.authModifierMotDePasseSchema = z.object({
    body: z.object({
...
exports.transactionCreerSchema = z.object({
    body: z.object({
        ...
        date: dateOptionnelleVersDate(),
        tags: z.array(z.string().max(50).trim()).optional().default([])
    })
});
exports.transactionModifierSchema = z.object({
    body: z
        .object({
            ...
            date: dateStringOptionnelleVersDate(),
...
exports.transactionListeQuerySchema = z.object({
    query: z.object({
...
exports.budgetCreerSchema = z.object({
    body: z.object({
...
exports.budgetModifierSchema = z.object({
    body: z.object({
...
exports.objectifCreerSchema = z.object({
    body: z.object({
...
exports.objectifContributionSchema = z.object({
    body: z.object({
        montant: z.number().positive('Le montant doit être positif').finite()
    })
});
exports.agentIAMessageSchema = z.object({
    body: z.object({
        message: z.string().min(1, 'Le message est requis').max(4000, 'Message trop long').trim(),
        conversationId: z.string().nullable().optional()
    })
});
exports.rapportPartagerEmailSchema = z.object({
    body: z.object({
...
exports.transactionRecurrenteCreerSchema = z.object({
    body: z.object({
...
exports.dashboardMetriquesQuerySchema = z.object({
    query: z.object({
        periode: z
